...
const images = {
  ...
  "destination-desktop": "../../assets/destination/background-destination-desktop.jpg",
  "destination-tablet": "../../assets/destination/background-destination-tablet.jpg",
  "destination-mobile": "../../assets/destination/background-destination-mobile.jpg",

  "crew-desktop": "../../assets/crew/background-crew-desktop.jpg",
  "crew-tablet": "../../assets/crew/background-crew-tablet.jpg",
  "crew-mobile": "../../assets/crew/background-crew-mobile.jpg",

  "technology-desktop": "../../assets/technology/background-technology-desktop.jpg",
  "technology-tablet": "../../assets/technology/background-technology-tablet.jpg",
  "technology-mobile": "../../assets/technology/background-technology-mobile.jpg",
};
